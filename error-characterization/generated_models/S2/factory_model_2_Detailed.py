...
3. Assumed the buffer connecting SRC to M1 is named "B_src_1", the buffer connecting M1 to M2 is named "B_1_2", and the buffer connecting M2 to Sink is named "B_2_3" based on the naming pattern provided in the description.
...
class SystemModel(Node):
    def __init__(self, env, id):
        ...
        # Initializing buffers with specific names
        buffer_names = ["B_src_1", "B_1_2", "B_2_3"]
        self.buffers = [Buffer(env, id=name, capacity=2) for name in buffer_names]
