...
containing a Machine, followed by a Buffer. Machine in each stage has a processing 
delay of 4.0,3 and2  seconds  with capacity 2,3,4 respectively. The output of Stage_3 
is connected to a Sink named SINK. There are 4 such sequences in parallel. Name 
...
in row2 and M3 in row4. Name 
cross conecting buffer as Cross_Buffer_1, Cross_Buffer_2, etc.Row index starts from 1"""
...
path = fig.render(filename="S13_GT", directory=".", format="png", cleanup=True)
TOP.validate()
TOP.show_hierarchy()
