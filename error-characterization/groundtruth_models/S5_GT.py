...
All machines are interconnected via buffers.
 Name buffers as B1, B2, B3,.. and Machines as M1,M2,... 
 All buffers have a capacity of 2. The sequence ends in a sink (ID=SINK). 
...
path = fig.render(filename="S5_GT", directory=".", format="png", cleanup=True)
TOP.validate()
TOP.show_hierarchy()
